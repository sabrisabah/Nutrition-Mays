...
# Fix Settings and Run Migrations Script for Dr. Mays Nutrition Platform
# This script fixes settings file permissions and runs migrations
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Fix Settings and Run Migrations Script${NC}"
echo -e "${BLUE}========================================${NC}"
...
echo -e "\n${BLUE}========================================${NC}"
echo -e "${GREEN}Settings and Migrations Fix Complete!${NC}"
echo -e "${BLUE}========================================${NC}"
