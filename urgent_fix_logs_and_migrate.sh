...
# Urgent Fix Logs and Migrate Script for Dr. Mays Nutrition Platform
# This script fixes all permissions and runs migrations
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Urgent Fix Logs and Migrate Script${NC}"
echo -e "${BLUE}========================================${NC}"
...
echo -e "\n${BLUE}========================================${NC}"
echo -e "${GREEN}Urgent Fix and Migrate Complete!${NC}"
echo -e "${BLUE}========================================${NC}"
