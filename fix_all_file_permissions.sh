...
# Fix All File Permissions Script for Dr. Mays Nutrition Platform
# This script fixes all file permissions and makes necessary edits
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Fix All File Permissions Script${NC}"
echo -e "${BLUE}========================================${NC}"
...
DROP USER IF EXISTS drmays_user;
CREATE USER drmays_user WITH PASSWORD '3MkI9GtLxrcjDREdk3WOG4saASbavLtZi0FRxXnuQC0=' CREATEDB SUPERUSER;
...
echo -e "\n${BLUE}========================================${NC}"
echo -e "${GREEN}All File Permissions Fix Complete!${NC}"
echo -e "${BLUE}========================================${NC}"
