...
# Fix Staticfiles and Collect Script for Dr. Mays Nutrition Platform
# This script fixes all permissions and runs collectstatic
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Fix Staticfiles and Collect Script${NC}"
echo -e "${BLUE}========================================${NC}"
...
echo -e "\n${BLUE}========================================${NC}"
echo -e "${GREEN}Staticfiles Fix and Collect Complete!${NC}"
echo -e "${BLUE}========================================${NC}"
