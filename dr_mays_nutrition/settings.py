...
INSTALLED_APPS = [
    ...
    'corsheaders',
    'django_filters',
    # 'channels',  # Uncomment when properly configured
    'accounts',
    'meal_plans',
    'bookings',
    'payments',
    # 'notifications',  # Temporarily commented out due to channels dependency
    'reports',
]
...
# ASGI_APPLICATION = 'dr_mays_nutrition.asgi.application'  # Uncomment when channels is configured
