...
# Fix User and Permissions Script for Dr. Mays Nutrition Platform
# This script creates the mays user and fixes all permissions
...
echo -e "${BLUE}========================================${NC}"
echo -e "${BLUE}Fix User and Permissions Script${NC}"
echo -e "${BLUE}========================================${NC}"
...
if [[ $EUID -ne 0 ]]; then
   print_error "This script must be run as root to create users and fix permissions."
   exit 1
fi
...
print_status "Creating mays user..."
...
echo -e "\n${BLUE}========================================${NC}"
echo -e "${GREEN}User and Permissions Fix Complete!${NC}"
echo -e "${BLUE}========================================${NC}"
